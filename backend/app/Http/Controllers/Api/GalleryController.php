...
class GalleryController extends Controller
{
    public function index()
    {
        ...
        // Get all media and add URL for each, filter out media without files
        $allMedia = Media::where('type', 'image')->latest()->get();
    ...
    public function deleteAllMedia()
    {
        ...
        return response()->json([
            ...
            'files_deleted' => $fileDeletedCount,
        ]);
    }
