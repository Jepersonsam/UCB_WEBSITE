...
// Helper to get avatar URL from member object (prioritizes avatar_url from API)
const getMemberAvatarUrl = (member: Member) => {
  // Priority 1: Use avatar_url from API if available
...
const fetchMembers = async () => {
  ...
  try {
    ...
    console.log('Fetched active members:', activeMembers.value.length)
  } catch (error) {
